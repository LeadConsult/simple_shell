 ...
 * Return: Void
 */
void chck_chain(info_t *info, char *buf, size_t *p, size_t i, size_t len)
{
	size_t j = *p;
...
/**
 * rep_alias - replaces an aliases in  tokenized string
 * @info:  parameter struct
 *
...
/**
 * rep_vars - replaces vars in  tokenized string
 * @info:  parameter struct
 *
 * Return: 1 if replaced, 0 otherwise
 */
